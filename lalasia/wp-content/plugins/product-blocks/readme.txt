...
ProductX Gutenberg WooCommerce Blocks is an all-in-one solution for creating  online store.

👉 **[ProductX Landing Page](https://www.wpxpo.com/productx/)**
...
- Shop Page
- Cart Page
- Single product Page using WooCommerce Builder
- Organize WooCommerce Products using Gutenberg Blocks
- Readymade Design Library
- Product Blocks

[youtube https://www.youtube.com/watch?v=bR2RPDtrFq4]


✨ [**12+ ProductX Addons**](https://www.wpxpo.com/productx/addons/)

### 👉 <a href="https://www.wpxpo.com/productx/addons/woocommerce-builder/" target="_blank">WooCommerce Builder</a>
The WooCommerce Builder addon lets you create custom templates for the shop, archive, and single product pages.

### 👉 <a href="https://www.wpxpo.com/productx/woocommerce-cart-page-builder/" target="_blank">Cart Page Builder</a>
Create Custom Cart Page Template using finely crafted Gutenberg Blocks for WooCommerce.

### 👉 <a href="https://www.wpxpo.com/productx/addons/woocommerce-builder/" target="_blank">Single Product Page Builder</a>
Create your own customized templates for single product pages and replace them with default templates.

[youtube https://www.youtube.com/watch?v=boVUQW66Wr0]

### ⚖️ <a href="https://www.wpxpo.com/productx/addons/product-comparison/" target="_blank">Products Compare</a>
Products Compare addon allows you to compare products of your shop by attributes and price.

### ⌛ <a href="https://www.wpxpo.com/productx/addons/product-image-flipper/" target="_blank">WooCommerce Image Flipper</a>
Flip Image addon lets you flip the featured image with another image from your gallery of the same product.

### 👁️ <a href="https://www.wpxpo.com/productx/addons/quick-view/" target="_blank">WooCommerce Quick View</a>
WooCommerce Quick View addon allows you to have a brief overview of every product in a popup.

### ❤️ <a href="https://www.wpxpo.com/productx/addons/wishlist/" target="_blank">WooCommerce Wishlist</a>
WooCommerce Wishlist addon allows your store visitors and customers to add products to wishlist.

### 👉 <a href="https://www.wpxpo.com/productx/addons/pre-order/" target="_blank">Pre order for WooCommerce</a>
Product Pre-order for WooCommerce is an effective feature to sell upcoming products on your WooCommerce store.

### 👉 <a href="https://www.wpxpo.com/productx/addons/backorder/" target="_blank">Backorder</a>
The Backorder addon helps you to take orders for the products that are currently out of stock but will be restocked soon.

### 👉 <a href="https://www.wpxpo.com/productx/addons/stock-progress-bar/" target="_blank">Stock Progress Bar</a>
The Stock Status Bar addon encourages prospective buyers to purchase items before they run out of stock by showing the total and remaining quantity of the products.

### 👉 <a href="https://www.wpxpo.com/productx/addons/call-for-price/" target="_blank">Call for Price for WooCommerce</a>
The Call for Price addon helps to hide the add to cart button while adding a calling button in place of the price.

### 👉 <a href="https://www.wpxpo.com/productx/addons/partial-payment/" target="_blank">Partial Payments</a>
The Partial Payments addon breaks down the total price in two installments.

### 👉 <a href="https://www.wpxpo.com/productx/addons/woocommerce-variation-swatches/" target="_blank">Product Variations Swatches for WooCommerce</a>
The Variation Swatches helps you to style the product attributes, color, size, and image or all of them simultaneously.

[youtube https://www.youtube.com/watch?v=i65S6QiFgFE]

- **WooCommerce Pagination**
WooCommerce Pagination helps to make the products arranged neatly and make them easily accessible. Product pagination is very easy to customize the product pagination feature in the Product blocks of Woocommerce to fit the needs of your Woocommerce store.

- **Product Slider**
The product slider would allow you to display your product in the format of a slide. Product slider is a very useful block to showcase your best products to the audience on the home page to grab their attention quickly.

- **Product Blocks for WooCommerce**
Product Blocks include WooCommerce Blocks, WooCommerce Slider, Starter Packs, Product Filter, Ajax Pagination, etc.

- **WooCommerce Product Sorting**
WooCommerce Product Sorting allows users to refine their product searches to quickly and easily locate the desired items.
...
== Changelog ==
= 2.3.3 - 3 August 2022 =
* Fix: Broken image design when category image is missing on Product Category 1 Blocks
* Fix: Broken image design when category image is missing on Product Category 2 Blocks
* Fix: Removing item from Wishlist doesn't work properly
* Fix: Product compare status is not changing after removing product from compare list
* Fix: Product Image Blocks appearing multiple times on Builder
* Fix: Rating star is not appearing properly on Product Review Blocks in block editor
* Fix: Rating star is not appearing properly on Product Rating Blocks in Storefront theme
* Fix: Broken Product Image Blocks design on Builder in Storefront theme
* Fix: Broken Buttons design on Cart Page Builder in Storefront theme
* Fix: Broken author image design on Product Review Blocks in Storefront theme
* Fix: Broken Navbar design on Product Tab Blocks in Storefront theme
* Fix: Background color doesn't work properly in the Additional Info tab on Product Tab Blocks in the Storefront theme
* Fix: Broken Product Review Blocks design on Kadence theme
* Fix: Broken Product Review Blocks design on GeneratePress theme
...
= 2.3.1 - 20 July 2022 =
* Fix: Broken Additional Info Block alignment on Builder
* Fix: Variation Swatches incompatible with Divi theme
* Fix: Quickview popup confliction on Divi theme
* Fix: In Wishlist popup for the variable product after clicking on the Select Options button redirects to the Cart Page instead of the Product Page
* Fix: After a product is added to the wishlist, clicking on the Continue Shopping button redirects incorrectly when the "Redirect to Page" option is selected in the Wishlist Addon setting
* Fix: Shortcode doesn't work properly on Builder

= 2.3.0 - 06 July 2022 =
* Fix: View Cart Showing Issue After Pagination
* Fix: Quickview Addons Issue
* Fix: Product Image Block Design Issue
* Fix: Product Add To Cart Block Design Issue
* Fix: Product Review Block Design Issue

= 2.2.9 - 29 June 2022 =
* Fix: Product Grid Add To Cart Issue
* Fix: Product Grid View Cart Issue
* Fix: WooCommerce Default Filter Issue in Shop Builder
* Fix: WooCommerce Default Filter Issue in Archive Builder
* Fix: Product Meta Issue in Single Product Builder
* Fix: Product Image Sale Style Issue in Single Product Builder
...
= 2.2.6 - 25 May 2022 =
* Fix: Data Escaped Issue

= 2.2.5 - 24 May 2022 =
* Fix: Many Variables and Options Escaped Issue

= 2.2.4 - 22 May 2022 =
* Fix: Data Sanitized, Escaped, and Validated Issue
...
= 2.1.5 - 26 January 2022 =
* Fix: Color Field CSS Broken Issue
* Fix: Builder Condition Button Broken Issue
* Fix: Product Grid #2, Product Grid #3, Product Grid #4 Pagination Issue
...
= 2.1.3 - 4 January 2022 =
* Fix: Group Product and Variable Product in Builder Broken Issue
...
* Fix: isActive Issue
* Fix: Backend Title Special Charecter Issue
